...
namespace Shout
{
	...
	{
		public static readonly string BASE_URL = "http://shout-dev.herokuapp.com";
		public static readonly string API_URI = "api";
		public static readonly string USERS_URI = "users";
